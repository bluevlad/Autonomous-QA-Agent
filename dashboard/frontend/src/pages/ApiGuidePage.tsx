    ...
    <Card
      ...
      title={
        <span>
          ...
          {endpoint.auth && (
            <Tag icon={<LockOutlined />} color="orange" style={{ marginLeft: 8 }}>
              API Key
            </Tag>
          )}
        </span>
...
export default function ApiGuidePage() {
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <Paragraph type="secondary">
        Endpoints marked with <Tag icon={<LockOutlined />} color="orange">API Key</Tag> require
        an <code>Authorization: Bearer &lt;API_KEY&gt;</code> header.
      </Paragraph>
